...
enum AIType {PATROLER, WAITANDGO, IGNORE }; // type of AI -> behavior/style
class Entity {
public:
    ...
    void Update(float deltaTime, Entity *player, Entity *objects, int objectCount, Map *map, int &lives, int leftBound, int rightBound);
    void Render(ShaderProgram *program);
    void DrawSpriteFromTextureAtlas(ShaderProgram *program, GLuint textureID, int index);
    
    void AI(Entity *player, int leftBound, int rightBound);
    void AIPatroler(int leftBound, int rightBound); // handles AI's that are Walkers
